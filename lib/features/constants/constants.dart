...
List<List<JourneyModel>> journeyModels = [
  [
    ...
    JourneyModel(
      ...
      timeOfRoundTrip: "3Day 5Hrs",
      descriptionOfRoute: "Bay of Bengal",
      cameraPositionLatitude: 20.281828,
      cameraPositionLongitude: 86.673204,
      zoomLevel: 5,
    ),
    JourneyModel(
